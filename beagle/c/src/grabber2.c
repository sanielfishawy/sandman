...
int main(int argc, char **argv)
{
        ...
        fd_set                          fds;
        struct timeval                  tv;
        int                             r, fd = -1, width = 1920, height = 1280;
        ...
        printf("Setting size to: %dx%d", width, height);
        ...
        for (i = 0; i < 2; i++) {
                ...
                printf("writing grabber%03d.ppm\n", i);
